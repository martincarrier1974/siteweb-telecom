...
import { FiHeadphones, FiMessageCircle, FiMail, FiPhone, FiClock, FiHelpCircle, FiDownload } from 'react-icons/fi'
          ...
          <div className="max-w-2xl mx-auto">
            <div className="card text-center">
              ...
              <p className="text-body mb-8">
                Téléchargez TeamViewer pour permettre à notre équipe de support de vous aider à distance
              </p>
              <a
                href="/TeamViewerQS.exe"
                download
                className="inline-flex items-center space-x-3 btn-primary text-lg px-8 py-4 hover:bg-primary-dark transition-all"
              >
                <Image
                  src="/teamviewerlogo.png"
                  alt="TeamViewer"
                  width={40}
                  height={40}
                  className="h-10 w-auto"
                />
                <span>Télécharger TeamViewer</span>
